...
<?
    echo SideNav::widget([
        'items' => [
            ...
            ['label' => Yii::t('app', 'Administration'), 'icon' => 'desktop', 'active' => (Yii::$app->CustomUtil->in_array(['user*','rbac*', $appId.'-company*',$appId.'-workplace*','docmgm*',$appId.'-category*'] ,$item )), 'items' => [
