...
class MenuBuilder 
{
    public static function BuildMenu($item)
    {
        ...
        if (Yii::$app->user->can('Application Admin')) {  
            array_push($items,        
                ['label' => Yii::t('app', 'Administration'), 'icon' => 'desktop', 'active' => (Yii::$app->CustomUtil->in_array(['user*','rbac*', $appId.'-company*',$appId.'-workplace*','docmgm-document-index', 'docmgm-document-create', 'docmgm-document-view*','docmgm-document-update*','docmgm-member-doc*' ,$appId.'-category*', $appId.'-log*', ],$item )), 'items' => [
                    ...
                    ['label' => Yii::t('app', 'Member Documents'), 'icon' => 'file', 'url' => Url::toRoute('/docmgm/member-doc/index'), 'active' => (Yii::$app->CustomUtil->in_array(['docmgm-member-doc-index'] ,$item ))],
        ...
        array_push($items, 
            ...
            ['label' => Yii::t('app', 'News'), 'icon' => 'globe', 'url' =>  Url::toRoute('/site/news'), 'active' => (Yii::$app->CustomUtil->in_array([$appId.'-site-news*'] ,$item ))],
            ['label' => Yii::t('app', 'Trainings'), 'icon' => 'bullhorn', 'url' =>  Url::toRoute('/docmgm/trainings-ovw/index'), 'active' => (Yii::$app->CustomUtil->in_array(['docmgm-trainings-ovw*'] ,$item ))]
        ); 
